...
**Status: Phase 9 (complete) —** sealed data governance (P1), dimension-typed
...
## Full run + dashboard (any pair)

```bash
# run the whole pipeline on ANY ForexSB JSON (BNBUSDT is just the first sample)
